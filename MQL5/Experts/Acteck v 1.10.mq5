...
#property description "Acteck v 1.10 — Expert Advisor for MetaTrader 5 (hedging)."
...
void ManagePositions()
{
   ...
   for(int i = total - 1; i >= 0; i--)
   {
      ...
      // Breakeven (v1.10): BE only after PartialClose step1 is completed, then after BE_Trigger additional points.
